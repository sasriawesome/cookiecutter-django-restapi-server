...
import datetime
import pydf
from {{cookiecutter.project_label}} import __version__ as version
...
PRODUCTION_APPS = [
    ...
    '{{cookiecutter.project_label}}.core',
    '{{cookiecutter.project_label}}.auth',
    '{{cookiecutter.project_label}}.admin',
    '{{cookiecutter.project_label}}.api',
    '{{cookiecutter.project_label}}.modules.todo',
...
WSGI_APPLICATION = '{{cookiecutter.project_label}}.wsgi.application'
...
ROOT_URLCONF = '{{cookiecutter.project_label}}.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                '{{cookiecutter.project_label}}.core.context_processors.settings',
            ],
        },
    },
]
...
AUTH_USER_MODEL = '{{cookiecutter.project_label}}_auth.User'
...
FORMAT_MODULE_PATH = [
    '{{cookiecutter.project_label}}.formats',
]
...
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER', '{{cookiecutter.project_label}}.noreply@gmail.com')
...
SWAGGER_SETTINGS = {
    'DEFAULT_AUTO_SCHEMA_CLASS': '{{cookiecutter.project_label}}.api.schemas.ReadWriteAutoSchema'
}
...
CACHES = {
    "default": {
        ...
        "KEY_PREFIX": os.getenv('SITE_NAME', '{{cookiecutter.project_label}}')
    },
}
